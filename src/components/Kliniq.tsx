              ...
              <div className="relative grid lg:grid-cols-12 gap-10">
                <div className="lg:col-span-7">
                  ...
                  <a
                    ...
                    className="mt-9 inline-flex items-center gap-2 rounded-lg bg-[#2563EB] hover:bg-[#1D4ED8] px-6 py-3.5 text-sm font-semibold text-white transition-colors"
                  >
                    Solicitar una demo
                    <ArrowRight size={15} />
                  </a>
                  ...
                  <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6 shadow-sm">
                    ...
                    <div className="space-y-3">
                      {kliniq.modules.map((m) => (
                        <div key={m.name} className="flex gap-3 pb-3 border-b border-[#F1F5F9] last:border-0 last:pb-0">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-[#64748B] mt-0.5 leading-relaxed">{m.text}</div>
                          </div>
                        </div>
                      ))}
                    </div>
